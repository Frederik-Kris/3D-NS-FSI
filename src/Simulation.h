...
private:
	...
	long unsigned timeLevel;		// No. of timesteps computed. Zero is IC.
	long unsigned timeLevelStart;	// Time level to start from, if simulation is continued from previous result.
};
